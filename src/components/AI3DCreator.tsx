...
const AI3DCreator: React.FC<{ onClose: () => void, onAssetGenerated: (voxels: Voxel[]) => void }> = ({ onClose, onAssetGenerated }) => {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-md animate-in fade-in duration-300">
      <div className="w-full max-w-lg bg-white rounded-[2rem] shadow-2xl border-4 border-cyan-500 overflow-hidden flex flex-col">
        ...
        <div className="p-6 flex flex-col gap-4">
            <div className="relative">
                <input 
                    ...
                    className="w-full pl-4 pr-12 py-4 bg-slate-100 rounded-2xl outline-none font-bold text-slate-700 focus:ring-2 focus:ring-cyan-400"
