...
const GameOverModal: React.FC<any> = ({ onRestart }) => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white rounded-[3rem] p-8 shadow-2xl border-4 border-slate-200 text-center animate-in zoom-in-95 duration-300">
        ...
        <div className="space-y-3">
          <button 
            ...
            className={`w-full py-4 rounded-2xl flex items-center justify-center gap-3 text-white font-black shadow-lg hover:scale-105 active:scale-95 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 ${isWin ? 'bg-emerald-500 hover:bg-emerald-600' : 'bg-blue-500 hover:bg-blue-600'}`}
          >
          ...
          <button 
            ...
            className="w-full py-4 rounded-2xl flex items-center justify-center gap-3 bg-slate-100 text-slate-600 font-bold hover:bg-slate-200 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2"
          >
