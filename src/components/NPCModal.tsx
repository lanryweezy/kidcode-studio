...
const NPCModal: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 z-[100] flex items-end justify-center p-8 bg-black/20 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl border-4 border-indigo-500 overflow-hidden animate-in slide-in-from-bottom-8 duration-500">
        ...
        {/* Footer / Interaction */}
        <div className="bg-slate-50 p-4 flex justify-end items-center border-t border-slate-100">
          <button 
            onClick={() => setNpcChat(null)}
