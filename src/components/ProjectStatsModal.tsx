...
const ProjectStatsModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-md animate-in fade-in duration-300">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl border-4 border-indigo-500 overflow-hidden flex flex-col animate-in zoom-in-95 duration-300">
            ...
            <div className="space-y-4">
                <div className="bg-white p-4 rounded-2xl border border-slate-200 flex items-center gap-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <p className="text-3xl font-black text-slate-800">{totalBlocks}</p>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-2xl border border-slate-200 flex items-center gap-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <p className="text-3xl font-black text-slate-800">{variableCount}</p>
                    </div>
                </div>
                ...
                {mode === AppMode.HARDWARE && (
                    <div className="bg-white p-4 rounded-2xl border border-slate-200 flex items-center gap-4 shadow-sm">
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-black text-slate-800">{circuitComponents.length}</p>
                        </div>
                    </div>
                )}
            </div>
