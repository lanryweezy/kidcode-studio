...
export enum CommandType {
  ...
  ADD_COLOR_PICKER = 'ADD_COLOR_PICKER', // New
  ADD_PROGRESS = 'ADD_PROGRESS', 
  ADD_MAP = 'ADD_MAP',
  ADD_CHART = 'ADD_CHART',
  ADD_QR_CODE = 'ADD_QR_CODE',
  ADD_RATING = 'ADD_RATING',
  ADD_DIVIDER = 'ADD_DIVIDER', // New
  ADD_SPACER = 'ADD_SPACER', // New
  ADD_ICON = 'ADD_ICON',
...
export interface AppElement {
  id: string;
  blockId?: string; 
  type: 'button' | 'text' | 'input' | 'image' | 'switch' | 'slider' | 'checkbox' | 'progress' | 'video' | 'map' | 'chart' | 'date' | 'camera' | 'drawing_canvas' | 'list' | 'divider' | 'spacer' | 'color_picker' | 'qr_code';
  content: string;
